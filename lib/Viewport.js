...
var Viewport = React.createClass({
  ...
  renderLockedCanvas: function() {
    ...
    return this.renderAnyCanvas("locked", this.props.lockedColumns,{width:width,overflowY:'hidden'});
  },
  ...
  renderRegularCanvas: function() {
    ...
    return this.renderAnyCanvas("regular", this.props.regularColumns,{width:width,left:lockWidth});
  },
